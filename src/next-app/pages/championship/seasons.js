...
export default function Seasons() {
    ...
    const table = seasons.map(season => {return([
        <TableHead>
            <TableRow>
        ...
        <TableHead>
            ...
            {season.drivers.map(driver => {return(
                <TableRow>
		...
		<div>
			...
			<div className={styles.container}>
                <div className={styles.Nav}>
                    <Link href={''}><a onClick={() => setSeason(0)}>2021</a></Link>
                    <Link href={''}><a onClick={() => setSeason(1)}>2022</a></Link>
                </div>
                <div className={styles.Nav}>
                    <Link href={''}><a onClick={() => setType(0)}>Races</a></Link>
                    <Link href={''}><a onClick={() => setType(1)}>Drivers</a></Link>
                    <Link href={''}><a onClick={() => setType(2)}>Drivers</a></Link>
                </div>
