		...
		<div>
			...
			<div className={styles.container}>
				<div className={styles.Nav}>
					<Link href={''}><a onClick={() => setTeam(0)}>Red Bull Racing</a></Link>
					<Link href={''}><a onClick={() => setTeam(1)}>Ferrari</a></Link>
					<Link href={''}><a onClick={() => setTeam(2)}>Mercedes</a></Link>
					<Link href={''}><a onClick={() => setTeam(3)}>McLaren</a></Link>
					<Link href={''}><a onClick={() => setTeam(4)}>Alfa Romeo</a></Link>
				</div>
                <div className={styles.Nav}>
					<Link href={''}><a onClick={() => setTeam(5)}>Alpine</a></Link>
					<Link href={''}><a onClick={() => setTeam(6)}>AlphaTauri</a></Link>
					<Link href={''}><a onClick={() => setTeam(7)}>Hass</a></Link>
					<Link href={''}><a onClick={() => setTeam(8)}>Astom Martin</a></Link>
					<Link href={''}><a onClick={() => setTeam(9)}>Williams</a></Link>
                </div>
				<div className={styles.team}>
					...
					<div className={styles.teamTable}>
						...
						<div className={styles.teamTableRow}>
							<div className={styles.teamTableHead}>Number of World Championship</div>
